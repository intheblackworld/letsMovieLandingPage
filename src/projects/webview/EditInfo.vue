    ...
    generateIntro() {
      ...
      switch (this.introForm.q1) {
        case 0:
          // 與人交談
          if (Math.random() >= 0.49) {
            intro.a1 = '我喜歡跟人聊天，如果對方需要，我會分享我所知道的一切'
          } else {
            intro.a1 = '我喜歡交朋友，喜歡新的交流帶來的有趣火花'
          }
          break
        case 1:
          // 樂於傾聽
          if (Math.random() >= 0.49) {
            intro.a1 = '我樂於傾聽，喜歡陪著對方一起體會他的經歷跟感觸'
          } else {
            intro.a1 = '我喜歡聽人說話，那些對我來說都是不可取代的禮物'
          }
          break
        case 2:
          // 兩者皆是
          if (Math.random() >= 0.49) {
            intro.a1 = '我喜歡交流，觀察對方的反應也喜歡分享我所知道的一切'
          } else {
      ...
      switch (this.introForm.q3) {
        case 0:
          // 和你的伴侶在冰天雪地中看著極光
          intro.a3 = `我重視未來的伴侶，也喜歡一起去累積回憶的畫面，如果可以。我想跟那個她，常常出遊，甚至來個不可思議的旅行，像是極光或火山，如果她敢去的話😂`
          break
        case 1:
          // 說走就走，背一個背包，環遊世界
          intro.a3 = `我喜歡冒險，甚至想要踏上未知的旅程，看這世界難得一見，罕有人跡的風景，就背著一個背包，一台手機，環遊這個世界與它對話`
          break
        case 2:
          // 擁有一棟房子，房子裡住著我愛的人跟愛我的人
          intro.a3 = `我重視身邊的人，想要他們獲得最好的東西。把錢花在重要的人身上，守護看似平凡實則寶貴的日常，是我最大的幸福`
          break
        case 3:
          // 成為某個領域中的專家，受人尊重，很多人都知道你，喜歡你，需要你的意見
          intro.a3 = `我對自己的專業充滿熱情，想要把自己變得更好，也想這個世界有我而變得有一點點不一樣`
          break
        default:
          break
      }
      ...
      switch (this.introForm.q5) {
        ...
        case 1:
          // 貓
          intro.a5 = `我應該像是一隻貓，有點神秘，有點悶騷，對新奇的事物沒有什麼抵抗力`
          break
        case 2:
          // 老鷹
        ...
        case 4:
          // 無尾熊
          intro.a5 = `我應該像是一隻無尾熊，讓人感覺到舒服，自在，沒有壓力`
          break
        case 5:
          // 狐狸
